...
{
    public partial class DeductionsMedicalCare : BasePage
    {
        #region Query
        ...
        {
            InitData(PageNumbers.ApplicationsHRDeductionsMedicalCare, (SessionUser)Session[SessionVariables.user]);
        ...
        private ApplicationActionResult GetData()
        {
            ...
            _listSalaryDeductionsDto = PageMethodsHelper.InvokeWebAPI<SalaryDeductionsDto>(
                WebAPIVariables.salaryDeductions, "?SalaryDeductionsType=" + (int)SalaryDeductionsType.MedicalCare);
        ...
        private void SaveNew()
        {
            var value = new SalaryDeductionsDto()
            {
                ...
                SalaryDeductionsType = (int)SalaryDeductionsType.MedicalCare
            };
