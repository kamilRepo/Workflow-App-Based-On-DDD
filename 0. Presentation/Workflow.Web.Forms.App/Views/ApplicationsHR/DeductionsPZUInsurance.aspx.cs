...
{
    public partial class DeductionsPZUInsurance : BasePage
    {
        #region Query
        ...
        {
            InitData(PageNumbers.ApplicationsHRDeductionsPZUInsurance, (SessionUser)Session[SessionVariables.user]);
        ...
        private ApplicationActionResult GetData()
        {
            ...
            _listSalaryDeductionsDto = PageMethodsHelper.InvokeWebAPI<SalaryDeductionsDto>(
                WebAPIVariables.salaryDeductions, "?SalaryDeductionsType=" + (int)SalaryDeductionsType.PZUInsurance);
