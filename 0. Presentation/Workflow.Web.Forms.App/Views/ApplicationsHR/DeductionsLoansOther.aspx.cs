...
{
    public partial class DeductionsLoansOther : BasePage
    {
        #region Query
        ...
        {
            InitData(PageNumbers.ApplicationsHRDeductionsLoansOther, (SessionUser)Session[SessionVariables.user]);
        ...
        private ApplicationActionResult GetData()
        {
            ...
            _listSalaryDeductionsDto = PageMethodsHelper.InvokeWebAPI<SalaryDeductionsDto>(
                WebAPIVariables.salaryDeductions, "?SalaryDeductionsType=" + (int)SalaryDeductionsType.LoansOther);
        ...
        private void SaveNew()
        {
            var value = new SalaryDeductionsDto()
            {
                ...
                SalaryDeductionsType = (int)SalaryDeductionsType.LoansOther,
