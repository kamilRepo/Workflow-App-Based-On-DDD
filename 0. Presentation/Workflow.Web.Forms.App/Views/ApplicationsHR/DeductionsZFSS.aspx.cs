...
{
    public partial class DeductionsZFSS : BasePage
    {
        #region Query
        ...
        private TextBox _contractNumber;
        private TextBox _firstInstallmentCapital;
        private TextBox _firstInstallmentInterest;
        private TextBox _monthlyCycle;
        ...
        {
            InitData(PageNumbers.ApplicationsHRDeductionsZFSS, (SessionUser)Session[SessionVariables.user]);
        ...
        private ApplicationActionResult GetData()
        {
            ...
            _listSalaryDeductionsDto = PageMethodsHelper.InvokeWebAPI<SalaryDeductionsDto>(
                WebAPIVariables.salaryDeductions, "?SalaryDeductionsType=" + (int)SalaryDeductionsType.ZFSS);
        ...
        private void CommandEdit(GridViewCommandEventArgs e)
        {
            ...
            EditGrid(_gridView, _rowIndex, 8);
            EditGrid(_gridView, _rowIndex, 9);
            EditGrid(_gridView, _rowIndex, 10);
        ...
        private void CommandSave(GridViewCommandEventArgs e)
        {
            ...
            _contractNumber = (TextBox)_gridView.Rows[_rowIndex].FindControl("ContractNumber");
            _firstInstallmentCapital = (TextBox)_gridView.Rows[_rowIndex].FindControl("FirstInstallmentCapital");
            _firstInstallmentInterest = (TextBox)_gridView.Rows[_rowIndex].FindControl("FirstInstallmentInterest");
            _monthlyCycle = (TextBox)_gridView.Rows[_rowIndex].FindControl("MonthlyCycle");
            ...
            SaveGrid(_gridView, _rowIndex, 8);
            SaveGrid(_gridView, _rowIndex, 9);
            SaveGrid(_gridView, _rowIndex, 10);
