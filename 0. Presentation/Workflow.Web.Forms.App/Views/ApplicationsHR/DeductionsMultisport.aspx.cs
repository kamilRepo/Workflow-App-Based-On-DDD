...
{
    public partial class DeductionsMultisport : BasePage
    {
        #region Query
        ...
        {
            InitData(PageNumbers.ApplicationsHRDeductionsMultisport, (SessionUser)Session[SessionVariables.user]);
        ...
        private ApplicationActionResult GetData()
        {
            ...
            _listSalaryDeductionsDto = PageMethodsHelper.InvokeWebAPI<SalaryDeductionsDto>(
                WebAPIVariables.salaryDeductions, "?SalaryDeductionsType=" + (int)SalaryDeductionsType.Multisport);
