<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchEmployee.aspx.cs" Inherits="Workflow.Web.Forms.App.Views.CardIndex.SearchEmployee" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-gray">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-xs-8 col-sm-4">
                <label>
                    <asp:Label ID="lbl_PhoneNumberLabel" runat="server" Text="<%$ Resources: Common, PhoneNumberLabel %>"></asp:Label>
                </label>
                <asp:TextBox ID="tb_PhoneNumber" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="form-group col-xs-8 col-sm-4">
                <label>
                    <asp:Label ID="lbl_MobilePhoneNumberLabel" runat="server" Text="<%$ Resources: Common, MobileNumberLabel %>"></asp:Label>
                </label>
                <asp:TextBox ID="tb_MobilePhoneNumber" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
