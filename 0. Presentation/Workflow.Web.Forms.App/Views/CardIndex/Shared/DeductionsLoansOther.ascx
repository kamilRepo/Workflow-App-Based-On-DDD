<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeductionsLoansOther.ascx.cs" Inherits="Workflow.Web.Forms.App.Views.CardIndex.Shared.DeductionsLoansOther" %>
