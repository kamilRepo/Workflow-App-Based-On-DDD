...
{
    public class SzpartaController : BaseApiController
    {
        #region Query
        ...
        [HttpGet]
        public Root<DictionaryDto> Szparta()
        {  
            return new Root<DictionaryDto> { Items = _dictionaryFinder.FindSilo() };
        }
