...
{
    public class OrganizationalCellsController : BaseApiController
    {
        #region Query
        ...
        public OrganizationalCellsController()
        {
            Resolve();
        }
        ...
        [HttpGet]
        public Root<DictionaryDto> OrganizationalCells()
        {  
            return new Root<DictionaryDto> { Items = _dictionaryFinder.FindOrganizationalCell() };
        }
